...
import Flight_Jet from '../assets/img/Flight_Jet.png'
import Saiykal from '../assets/img/Sayikal_Cartun.png'
import Cap_Cartun from '../assets/img/Cap_Cartun.png'
import Could_Right from '../assets/img/Cloud_Right.png'
import bottom_Elipse from '../assets/img/bottomElipse.png'
...
const HeroSec = () => {
    ...
    return (
        <div className='bg-[url(../src/assets/img/herobgimg.png)] bg-cover bg-no-repeat bg-center  min-h-screen lg:min-h-[130vh]  relative z-[1] overflow-hidden'>
                ...
                <div className=' pt-8'>
                    <nav className='flex justify-between bg-white px-3 border-b-[#000000] border-solid border-b-4 rounded-[61.1px] items-center '>
                        ...
                        <ul className={`${nav ? "left-0" : "left-[-100%]"} items-center  mobileView duration-300 flex gap-[28px]`}>
                            ...
                            <li onClick={show} className='min-[401px]:hidden bg-[url(../src/assets/img/bgbtnimg.png)] bg-cover group bg-center bg-no-repeat'>
                        ...
                        <div className='flex items-center gap-[8px]'>
                            ...
                            <button className='max-[400px]:hidden bg-[url(../src/assets/img/bgbtnimg.png)] bg-cover group bg-center bg-no-repeat'>
                                <p className='pt-[11px] pb-[19.57px] px-[36px] text-[18px] group-hover:text-white transition-all duration-300 ease-linear font-normal text-black font-chewy leading-[131%]'>Join Now</p>
                            </button>
