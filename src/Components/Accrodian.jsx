            ...
            <div id="faq" className="relative">
                ...
                <div className="max-w-[1140px] mx-auto px-3  ">
                    ...
                    <div data-aos="zoom-in" data-aos-once='true' className=" mx-auto relative max-w-[800px] px-2 ">
                        <Accordion className={` sm:pb-[27px] border mb-4 rounded-full sm:ps-[26px] border-[#C5C5C5]  p-3 sm:pt-[30px]  ${open === "A" ? 'rounded-[26px] sm:rounded-[45px] ' : 'rounded-full'}`} open={open === 1} icon={<Icon id={'A'} open={open} />}                >
                            <AccordionHeader onClick={() => handleOpen("A")} className=" text-[11px] sm:text-[16px] md:text-[20px] font-balsamiq text-start font-bold text-white w-full justify-between" >Maecenas laoreet, sapien vel cursus ultricies?</AccordionHeader>
                        ...
                        <Accordion className={` border   border-[#C5C5C5] rounded-full mb-4 p-3 sm:pt-[30px] sm:pb-[27px] sm:ps-[26px] overflow-hidden ${open === "B" ? 'rounded-[26px] sm:rounded-[45px]' : 'rounded-full'}`} open={open === 'B'} icon={<Icon id={"B"} open={open} />} >
                            <AccordionHeader onClick={() => handleOpen("B")} className=" text-[11px] text-white font-balsamiq sm:text-[16px] md:text-[20px] text-start font-bold "> Maecenas laoreet, sapien vel cursus ultricies?</AccordionHeader>
                        ...
                        <Accordion className={` border mb-4 rounded-full p-3 border-[#C5C5C5] sm:pt-[30px] sm:pb-[27px] sm:ps-[26px] ${open === 'C' ? 'rounded-[26px] sm:rounded-[45px]' : 'rounded-full'}`} open={open === "C"} icon={<Icon id={"C"} open={open} />}>
                            <AccordionHeader onClick={() => handleOpen("C")} className="font-balsamiq text-[11px] sm:text-[16px] md:text-[20px] text-start font-bold text-white" >Maecenas laoreet, sapien vel cursus ultricies?</AccordionHeader>
                        ...
                        <Accordion className={` border mb-4 rounded-full p-3 sm:pt-[30px] border-[#C5C5C5] sm:pb-[27px] sm:ps-[26px] ${open === 'D' ? 'rounded-[26px] sm:rounded-[45px]' : 'rounded-full'}`} open={open === 'D'} icon={<Icon id={"D"} open={open} />}>
                            <AccordionHeader onClick={() => handleOpen("D")} className="font-balsamiq text-[11px] sm:text-[16px] md:text-[20px] text-start font-bold text-white">Maecenas laoreet, sapien vel cursus ultricies?</AccordionHeader>
                        ...
                        <Accordion className={` border mb-4 rounded-full p-3 sm:pt-[30px] sm:pb-[27px] border-[#C5C5C5] sm:ps-[26px] ${open === 'E' ? 'rounded-[26px] sm:rounded-[45px]' : 'rounded-full'}`} open={open === 'E'} icon={<Icon id={'E'} open={open} />}>
                            <AccordionHeader onClick={() => handleOpen("E")} className="font-balsamiq text-[11px] sm:text-[16px] md:text-[20px] text-start font-bold text-white">Maecenas laoreet, sapien vel cursus ultricies?</AccordionHeader>
